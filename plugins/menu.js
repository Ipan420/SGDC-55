...
let handler  = async (m, { conn, args, usedPrefix: _p }) => {
 try {
    ...
    let cown = '6282286818715@s.whatsapp.net'
    let mmk = m.sender
...
*━━━━━━━━━━━━━━━━━━━━*
*☬ғᴏʟʟᴏᴡ ɪɴsᴛᴀɢʀᴀᴍ ᴍʏ ᴏᴡɴᴇʀ:☬*
*Https://www.instagram.com/ipan_4200*
*━━━━━━━━━━━━━━━━━━━━*
*╭══════════════════╮*
...
`.trim()
  /*  await conn.sendFile(m.chat, poto, 'SGDC-BOT.jpg', mn, m, false, { 
   ...
   /* } else {
    ...
    conn.fakeReply(m.chat, `Untuk Menu Gretongan, Ketik *${_p}gretongmenu*`, '0@s.whatsapp.net', '*IPAN IP-BOT || SUPPORT ME WITH DONATE*')
  } catch (e) {
